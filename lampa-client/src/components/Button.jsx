...
const Button = ({ children, to, onClick, variant = 'primary', className = '' }) => {
  ...
  const styles = {
    primary: { ...base, background: '#1a1a1a', color: '#fff', border: '1.5px solid #1a1a1a' },
    outline: { ...base, background: 'transparent', color: '#1a1a1a', border: '1.5px solid #1a1a1a' },
    secondary: { ...base, background: 'transparent', color: '#1a1a1a', border: '1.5px solid #1a1a1a' },
  };
