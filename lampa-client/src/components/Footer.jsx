...
const Footer = () => {
  return (
    <footer style={{ background: '#1a1a1a', color: '#ffffff', padding: '3rem', marginTop: 'auto' }}>
      <div style={{
        maxWidth: '1200px',
        margin: '0 auto',
        display: 'grid',
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
            <CatLogo />
            <p style={{ fontSize: '14px', fontWeight: '700', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#ffffff' }}>
              Cat Memes
            </p>
          </div>
          <p style={{ fontSize: '12px', color: '#aaa', lineHeight: '1.7', maxWidth: '220px' }}>
            A collection of the internet's most beloved cat memes, from crying cats to peaceful leaf hats.
          </p>
        </div>

        <div>
          <p style={{ fontSize: '10px', fontWeight: '600', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#888', marginBottom: '1rem' }}>
            Navigation
          </p>
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', padding: 0, margin: 0 }}>
            {[['/', 'Home'], ['/about', 'About'], ['/articles', 'Articles']].map(([path, label]) => (
              <li key={path}>
                <Link to={path} style={{ fontSize: '13px', color: '#ccc', textDecoration: 'none' }}>
                  {label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <p style={{ fontSize: '12px', color: '#aaa', lineHeight: '1.7' }}>
            Dedicated to cats and their chaotic, wholesome, and dramatic internet presence. Because every mood has a cat meme.
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '11px', color: '#666' }}>2026 Cat Memes. All rights reserved.</p>
        <p style={{ fontSize: '11px', color: '#666' }}>Made with React</p>
      </div>
    </footer>
  );
};
